-- #315acd = "SeaShell", HotPink = "#305050", #DCDCDC = "Crimson",
local M = {}
...
-- all colors that I want to highlight, including lower case version
M.toHighlight = {}
for key, value in pairs(colors) do
	M.toHighlight[string.lower(key)] = value
	M.toHighlight[key] = value
end
