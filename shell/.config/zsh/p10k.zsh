# Generated by Powerlevel10k configuration wizard on 2023-02-07 at 01:30 GMT.
...
# dotted, right frame, darkest-ornaments, sparse, many icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 72 )) && branch[25,-13]="…"  # <-- this line
...
# This is port asdf to mise
  ...
  # Go version from asdf.
  typeset -g POWERLEVEL9K_ASDF_GOLANG_FOREGROUND=172
  ...
  typeset -g POWERLEVEL9K_ASDF_DENO_FOREGROUND=27
  typeset -g POWERLEVEL9K_ASDF_DENO_VISUAL_IDENTIFIER_EXPANSION='🦕'
  typeset -g POWERLEVEL9K_ASDF_DENO_SHOW_ON_UPGLOB='deno.json'

  typeset -g POWERLEVEL9K_ASDF_BUN_FOREGROUND=214
  typeset -g POWERLEVEL9K_ASDF_BUN_VISUAL_IDENTIFIER_EXPANSION='🧅'
  typeset -g POWERLEVEL9K_ASDF_BUN_SHOW_ON_UPGLOB='bun.env'
