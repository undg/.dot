...
name: grug
description: >
  Ultra-compressed communication mode. Cuts token usage ~85% by dropping
  filler, articles, and pleasantries while keeping full technical accuracy.
  Use when user says "hey grug", "grug how are you", "use grug",
  "knock knock", "grug", or invokes /grug.
---
